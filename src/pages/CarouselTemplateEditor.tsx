...
function BackgroundLayerRow({
  ...
  return (
    <div className="overflow-hidden rounded-[12px] border border-[#d9dcdf] bg-white">
      <button
        type="button"
        onClick={onClick}
        className={[
...
export default function CarouselTemplateEditor() {
  ...
  const currentBackground = BACKGROUND_ASSETS.find((item) => item.id === selectedBackgroundId) ?? BACKGROUND_ASSETS[1];
            ...
            {BACKGROUND_ASSETS.map((asset) => (
              <button
                ...
                onClick={() => {
                  ...
                  setActiveTextLayerId(null);
                  setActiveStickerLayerId(null);
                  setLastAction(`Selected ${asset.label}`);
                }}
                className={[
              ...
              <div className="flex min-w-0 flex-1 justify-between bg-[#ffffff] pb-[76px]">
                ...
                <div className="flex w-[296px] flex-col bg-[#f2f2f2] py-5">
                  <div className="mx-3 flex min-h-0 flex-1 flex-col rounded-[16px] bg-[#ffffff] px-4 py-6 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
                    ...
                    {draggingLayerId && firstDraggableLayerId && draggingLayerId !== firstDraggableLayerId && (
                      <div
                        onDragOver={(event) => {
                          event.preventDefault();
                          event.dataTransfer.dropEffect = 'move';
                    ...
                    <BackgroundLayerRow
                      label="Background"
                      asset={currentBackground}
                      active={activeLayerKey === 'backgroundPrimary'}
                      onClick={() => {
                        setActiveLayerKey('backgroundPrimary');
                        setActiveTextLayerId(null);
                        setActiveStickerLayerId(null);
