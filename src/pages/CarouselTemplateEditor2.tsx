...
const SAVED_TEMPLATES: TemplateCard[] = TEMPLATE_GROUPS.flatMap((group) => group.items).slice(0, 8);
...
export default function CarouselTemplateEditor2() {
          ...
          <>
            ...
            <div className="absolute inset-y-0 right-0 flex w-[1120px] bg-neutral-surface shadow-[-12px_0_40px_rgba(0,0,0,0.14)]">
              ...
              <div className="flex min-w-0 flex-1 justify-between bg-[#ffffff] pb-[76px]">
                ...
                <div className="flex w-[424px] flex-col items-center bg-[#f2f2f2] px-4 py-6">
                ...
                <div className="flex w-[296px] flex-col bg-[#f2f2f2] py-5">
